...
import ingjulianvega.ximic.msscasusystemcheck.configuration.SystemCheckParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(SystemCheckParameters systemCheckParameters) {
        this.systemCheckParameters = systemCheckParameters;
    }

    SystemCheckParameters systemCheckParameters;


    @ExceptionHandler(SystemCheckException.class)
    public ResponseEntity<ApiError> validationErrorHandler(SystemCheckException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(systemCheckParameters.getApi())
